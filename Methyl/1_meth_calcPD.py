...
def main():
    ...
    parser.add_argument('--numShared', action="store", dest="min_shared", default=100, help="[Optional] Minimum number CpG shared between each sample and cell type comparison (Default: 100)")
